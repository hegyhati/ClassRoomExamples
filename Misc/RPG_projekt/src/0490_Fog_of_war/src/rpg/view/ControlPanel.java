...
class ControlPanel extends ViewPanel {
    ...
    public void updateView() {
        ...
        upButton.setEnabled(hero.isAlive() && !model.canSeeWall(-1,0));
        downButton.setEnabled(hero.isAlive() && !model.canSeeWall(1,0));
        leftButton.setEnabled(hero.isAlive() && !model.canSeeWall(0,-1));
        rightButton.setEnabled(hero.isAlive() && !model.canSeeWall(0,1));
    }
}